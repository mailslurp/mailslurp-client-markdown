...
**readOnly** | [**Boolean**](boolean) | Is the inbox readOnly for the caller. Read only means can not be deleted or modified. | [optional] [default to null]
...
**teamAccess** | [**Boolean**](boolean) | Does inbox permit team access for organization team members. If so team users can use inbox and emails associated with it. | [optional] [default to null]
