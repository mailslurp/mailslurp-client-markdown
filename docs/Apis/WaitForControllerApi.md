...
# **waitForEmailCount**
> List waitForEmailCount(count, delay, inboxId, since, sort, timeout, unreadOnly)
...
> List waitForMatchingEmails(matchOptions, count, delay, inboxId, since, sort, timeout, unreadOnly)
