...
<a name="getEmails"></a>
# **getEmails**
> List getEmails(inboxId, delayTimeout, limit, minCount, retryTimeout, since, size, sort, unreadOnly)
...
# **getInboxSentEmails**
> PageSentEmailProjection getInboxSentEmails(inboxId, page, searchFilter, size, sort)
...
> PageOrganizationInboxProjection getOrganizationInboxes(page, searchFilter, size, sort)
...
# **listInboxRulesets**
> PageInboxRulesetDto listInboxRulesets(inboxId, page, searchFilter, size, sort)
...
> PageTrackingPixelProjection listInboxTrackingPixels(inboxId, page, searchFilter, size, sort)
