...
<a name="getEmails"></a>
# **getEmails**
> List getEmails(inboxId, Alias for limit. Assessed first before assessing any passed limit., limit, Sort the results by received date and direction ASC or DESC, retryTimeout, delayTimeout, minCount, unreadOnly, before, since)
