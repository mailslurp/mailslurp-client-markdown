...
# **getAllGroups**
> Page_GroupProjection_ getAllGroups(page, size, sort)
...
[**Page_GroupProjection_**](..//Models/Page_GroupProjection_.md)
...
> Page_ContactProjection_ getGroupWithContactsPaginated(groupId, page, size, sort)
