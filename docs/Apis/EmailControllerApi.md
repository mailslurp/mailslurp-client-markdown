...
# **getEmailsPaginated**
> PageEmailProjection getEmailsPaginated(inboxId, page, searchFilter, size, sort, unreadOnly)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inboxIds** | [**List**](../Models/UUID)| Optional set of inboxes to filter by. Only get the latest email from these inbox IDs. If not provided will search across all inboxes | [optional] [default to null]
...
> PageEmailProjection getOrganizationEmailsPaginated(inboxId, page, searchFilter, size, sort, unreadOnly)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inboxId** | [**UUID**](../Models/)| ID of the inbox you want to send the email from | [optional] [default to null]
