 ...
 **tags** | [**List**](..//Models/String.md)| Tags that inbox has been tagged with. Tags can be added to inboxes to group different inboxes within an account. You can also search for inboxes by tag in the dashboard UI. | [optional] [default to null]
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **createInboxDto** | [**CreateInboxDto**](..//Models/CreateInboxDto.md)| createInboxDto |
...
[**PageOrganizationInboxProjection**](..//Models/PageOrganizationInboxProjection.md)
