...
# **getAllInboxes**
> Page«InboxProjection» getAllInboxes(favourite, page, search, size, sort, tag)
...
[**Page«InboxProjection»**](..//Models/Page«InboxProjection».md)
...
> Page«EmailPreview» getInboxEmailsPaginated(inboxId, page, size, sort)
...
[**Page«EmailPreview»**](..//Models/Page«EmailPreview».md)
...
# **getInboxSentEmails**
> Page«SentEmailProjection» getInboxSentEmails(inboxId, page, size, sort)
